...
export async function signUp(email, password, displayName) {
  try {
    ...
    throw createAuthError(error, "Unable to sign up right now.");
  }
}
...
export async function logIn(email, password) {
  try {
    ...
    throw createAuthError(error, "Unable to log in right now.");
  }
}
...
export async function signInWithGoogle() {
  try {
    ...
    throw createAuthError(error, "Unable to sign in with Google right now.");
  }
}
...
export async function logOut() {
  try {
    ...
    throw createAuthError(error, "Unable to log out right now.");
  }
}
...
export async function updateAccountEmail(newEmail) {
  try {
    ...
    throw createAuthError(error, "Unable to update email right now.");
  }
}
...
export async function updateAccountPassword(newPassword) {
  try {
    ...
    throw createAuthError(error, "Unable to update password right now.");
  }
}
...
export async function reauthenticateCurrentUser({ authProvider, email, password }) {
  try {
    ...
    throw createAuthError(error, "Unable to verify your login. Please try again.");
  }
}
...
export async function deleteAccountWithProfile() {
  try {
    ...
    throw createAuthError(error, "Unable to delete account right now.");
  }
}
